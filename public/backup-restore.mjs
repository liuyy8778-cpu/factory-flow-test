...
var BACKUP_TABLES = ["partners", "documents", "invoices", "payments", "sales_orders", "work_orders", "production_reports", "spec_options", "material_specs", "drawings", "intakes", "material_drafts", "number_counters", "barrel_entries", "barrel_audit", "intake_allocations", "intake_audit", "drawing_specs", "drawing_audit", "operation_audit", "audit_context", "series_drawings", "series_drawing_rows"];
